...
from app.dtos.dice import DiceDTO, DiceShowDTO, ExecuteDicesDTO, UserBulletsDTO
...
@dices_router.get("", response_model=ResponseModelDTO[ProductModelDTO])
...
@dices_router.get("/all", response_model=ResponseModelDTO[list[ProductModelDTO]])
async def get_all():
...
@dices_router.post("", response_model=ResponseModelDTO[ProductModelDTO])
...
@dices_router.put("", response_model=ResponseModelDTO[ProductModelDTO])
async def update(
    id: str,
    product: CreateProductDTO,
):
...
@dices_router.delete("", response_model=ResponseModelDTO[ProductModelDTO])
...
@dices_router.post("/review", response_model=ResponseModelDTO[ProductModelDTO])
...
async def execution_dices(
    ...
    return ResponseDTO(data=execution, message="success")
